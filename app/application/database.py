...
class DataBase:
    ...
    def close(self):
        # close the db connection and return: None
    ...
    def get_all_messages(self, limit=100, name=None):
        ...
        # returns all messages -->param limit: int -->return: list[dict]
    ...
    def get_messages_by_name(self, name, limit=100):
        # Gets a list of messages by user name -->param name: str -->return: list

        return self.get_all_messages(limit, name)

    def save_message(self, name, msg):

        # saves the given message in the table -->param name: str, msg: str ,time: datetime -->return: None
